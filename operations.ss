(module operations mzscheme
  ...
  (define-struct (operation:replace-world operation) (world))
  
  
  ;; Fixme: start turning on more operations as DivaScheme becomes
  ;; operations based.
  ...
  (provide/contract [struct operation ()]
                    [struct (operation:replace-world operation)
                            ([world World?])]
