...
(define-struct dstx (properties) #:prefab)
(define-struct (atom dstx) (content) #:prefab)
(define-struct (special-atom dstx) (content width) #:prefab)
(define-struct (space dstx) (content) #:prefab)
(define-struct (sentinel-space space) () #:prefab)
(define-struct (fusion dstx) (prefix children suffix) #:prefab)
